...
class MovieAdapter(private val onItemClick: (MovieEntity) -> Unit) :
    ListAdapter<MovieEntity, MovieAdapter.MovieViewHolder>(DIFFUTIL) {
    ...
    class MovieViewHolder(private val binding: ItemMovieBinding, val onItemClick: (MovieEntity) -> Unit) :
